        ...
        <div className="relative z-10 flex flex-col justify-center h-full max-w-[500px] mx-auto w-full pt-10">
          ...
          <div className="flex gap-3">
            <div className="bg-black/30 backdrop-blur-md rounded-xl p-4 w-[140px] border border-white/5 flex flex-col justify-center">
              <div className="text-[#BDF525] text-xl font-bold mb-1">2.4K+</div>
              <div className="text-white/70 text-[10px] font-bold uppercase tracking-wider leading-tight">Sheep Tracked</div>
            </div>
            <div className="bg-black/30 backdrop-blur-md rounded-xl p-4 w-[140px] border border-white/5 flex flex-col justify-center">
              <div className="text-[#BDF525] text-xl font-bold mb-1">98%</div>
              <div className="text-white/70 text-[10px] font-bold uppercase tracking-wider leading-tight mt-1">ADG Accuracy</div>
            </div>
          </div>
        </div>
      </div>
