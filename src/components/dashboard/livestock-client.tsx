...
import { Search, Warehouse, Activity, Edit2, ChevronLeft, ChevronRight, BookOpen, QrCode, PlusCircle, Users, Printer, Trash2, Eye, FileSpreadsheet, ArrowUpDown } from "lucide-react"
...
export function LivestockClient({
    ...
    const filteredLivestocks = useMemo(() => {
        let result = livestocks.filter(animal => {
        ...
        // Sort by ID
        result.sort((a, b) => {
            const idA = a.qr_code || a.id;
            const idB = b.qr_code || b.id;
            if (sortOrder === "asc") {
        ...
        return result;
    }, [livestocks, searchQuery, filterCage, filterStatus, sortOrder])
