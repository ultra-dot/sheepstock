    ...
    return (
        <main className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
            ...
            <section id="fitur" className="py-14 px-4 sm:px-6 lg:px-8">
                <div className="max-w-[1000px] mx-auto grid lg:grid-cols-2 gap-8 overflow-hidden">
                    {/* LEFT: Text + 2x2 Cards */}
            ...
            <section id="harga" className="py-20 px-4 sm:px-6 lg:px-8 max-w-[1000px] mx-auto overflow-hidden">
                ...
                <div className="grid lg:grid-cols-3 gap-6 items-center">
                    {/* Free */}
                    <ScrollReveal direction="up" delay={100} className="bg-white rounded-[2rem] p-7 border border-slate-200 shadow-sm flex flex-col h-[420px]">
                    ...
                    {/* Enterprise */}
                    <ScrollReveal direction="up" delay={500} className="bg-white rounded-[2rem] p-7 border border-slate-200 shadow-sm flex flex-col h-[420px]">
            ...
            {/* TESTIMONIAL */}
            <section id="tentang" className="py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            {/* CONTACT */}
            <section id="kontak" className="py-20 bg-[#ffffff] overflow-hidden">
                <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-5 gap-6">
                        {/* LEFT: Info + Map */}
                        <ScrollReveal direction="left" delay={200} className="lg:col-span-2 flex flex-col gap-4">
                            {/* Info Cards */}
